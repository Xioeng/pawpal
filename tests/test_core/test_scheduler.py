...
def test_schedule_tasks_single_task_fits():
...
def test_schedule_tasks_single_task_doesnt_fit():
...
def test_schedule_tasks_multiple_fit():
...
def test_schedule_tasks_multiple_partial_fit():
...
def test_schedule_tasks_none_fit():
...
def test_schedule_tasks_by_priority():
...
def test_schedule_tasks_high_priority_first():
...
def test_schedule_tasks_with_frequency():
...
def test_schedule_tasks_multiple_frequencies():
...
def test_is_feasible_exact_fit():
...
def test_explain_scheduling_basic():
...
def test_explain_scheduling_details():
...
def test_explain_scheduling_with_remaining_time():
...
def test_explain_scheduling_full_capacity():
