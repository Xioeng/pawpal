...
def test_owner_init_with_contact_info():
...
def test_remove_nonexistent_pet():
...
def test_remove_pet_from_empty_list():
...
def test_set_single_preference():
...
def test_set_multiple_preferences():
...
def test_get_info_with_contact():
