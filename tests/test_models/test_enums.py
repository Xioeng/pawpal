...
def test_priority_comparison_high_less_than_medium():
    """Test that HIGH < MEDIUM"""
    assert Priority.HIGH < Priority.MEDIUM


def test_priority_comparison_medium_less_than_low():
    """Test that MEDIUM < LOW"""
    assert Priority.MEDIUM < Priority.LOW


def test_priority_comparison_high_less_than_low():
    """Test that HIGH < LOW"""
    assert Priority.HIGH < Priority.LOW


def test_priority_comparison_not_greater_than():
...
def test_priority_comparison_with_self():
...
def test_priority_enum_all_members():
